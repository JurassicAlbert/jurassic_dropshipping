...
- **Apply same transition pattern next:** capital adjustment, return policy save, supplier reliability refresh, risk refresh buttons (optional but keeps behavior consistent).
